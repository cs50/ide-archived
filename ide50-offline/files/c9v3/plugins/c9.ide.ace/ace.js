            ...
            function fnWrap(command) {
                ...
                command.isAvailable = function(editor, args, event) {
                    ...
                    if (event instanceof KeyboardEvent && (!editor.ace.isFocused())) {
                        ...
                        if (!editor || !editor.ace || !editor.ace.isFocused())
                            return false;
                        if (!editor.ace.commands.byName[this.name])
                            return false;
                    }
                ...
                command.findEditor = function(editor) {
                    var ace = editor && editor.ace || editor;
                    if (ace && !ace.isFocused() && apf.activeElement) {
                        if (apf.activeElement.ace && apf.activeElement.ace.isFocused())
                            ace = apf.activeElement.ace;
                    }
                    return ace;
                };
