...
module.exports = function(options) {
    ...
    var plugins = [
        ...
        },
        {
            ...
            interval: 30 * 60 * 1000,
            ssh: ssh,
            containers: options.pricing.containers,
            accountUrl: options.accountUrl
        },
        "plugins/c9.ide.performancestats/stats_analytics",
        {
            packagePath: "plugins/c9.ide.performancestats/processlist"
        },
        {
    ...
    plugins.push(
        {
            packagePath: "plugins/c9.ide.simple/simple",
            staticPrefix: staticPrefix + "/plugins/c9.ide.layout.classic"
        }
    )
    return plugins;
